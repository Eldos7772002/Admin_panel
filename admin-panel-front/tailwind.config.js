...
const generatePalette = require(path.resolve(__dirname, ('src/assets/tailwind/utils/generate-palette')));
...
const config = {
    ...
    plugins    : [
        ...
        require(path.resolve(__dirname, ('src/assets/tailwind/plugins/utilities'))),
        require(path.resolve(__dirname, ('src/assets/tailwind/plugins/icon-size'))),
        require(path.resolve(__dirname, ('src/assets/tailwind/plugins/theming')))({themes}),
